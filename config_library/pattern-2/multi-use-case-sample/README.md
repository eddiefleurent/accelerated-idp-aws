...
USE_CASE_CONFIGS=$(python3 -c "import json; print(json.dumps(json.load(open('config_library/pattern-2/multi-use-case-sample/use_cases.json'))))")
...
JSON_FILE="config_library/pattern-2/multi-use-case-sample/use_cases.json"
if [[ ! -f "$JSON_FILE" ]]; then
